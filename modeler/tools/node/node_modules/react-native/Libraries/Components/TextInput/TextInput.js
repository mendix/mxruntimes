...
const TextInputEventEmitter = require('TextInputEventEmitter');
...
const TextInput = createReactClass({
  ...
  componentDidMount: function() {
    ...
    TextInputEventEmitter.on('tapOutside', this._onTapOutside);
  },
  ...
  componentWillUnmount: function() {
    ...
    TextInputEventEmitter.removeListener('tapOutside', this._onTapOutside);
  },
  ...
  _onTapOutside: function() {
    if (this.isFocused() && this.props.onBlur) {
      this.props.onBlur({type: 'tapOutside'});
    }
  },
