 ...
 */
class AlertIOS {
  // Temporary fix for https://github.com/facebook/react-native/issues/27072
  static refocusID = null;
  ...
  static alert(
    ...
    this.refocusID = TextInputState.currentlyFocusedField();
  ...
  static prompt(
    ...
    RCTAlertManager.alertWithArgs(
      ...
      (id, value) => {
        ...
        cb && cb(value);
        if (this.refocusID !== null) {
          TextInputState.focusTextInput(this.refocusID);
          this.refocusID = null;
        }
      },
    );
